...
class AppRouter extends _i8.RootStackRouter {
  ...
  List<_i8.RouteConfig> get routes => [
        ...
        _i8.RouteConfig(SignInRoute.name, path: '/sign_in'),
        _i8.RouteConfig(AuthorizationRoute.name, path: '/auth'),
        _i8.RouteConfig(DashboardRoute.name, path: '/dashboard'),
        _i8.RouteConfig(FavoriteSongsRoute.name, path: '/favorite_songs'),
        _i8.RouteConfig(SearchedSongsRoute.name, path: '/searched_songs'),
        _i8.RouteConfig(SongDetailRoute.name, path: '/song_detail')
      ];
}
