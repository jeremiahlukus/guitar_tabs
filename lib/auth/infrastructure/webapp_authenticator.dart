...
class WebAppAuthenticator {
  ...
  static Uri authorizationEndpoint() {
    if (getIsDebugMode()) {
      ...
      return Uri.parse('http://api.joyful-noise.link/users/sign_in');
    }
  }
  ...
  static Uri revocationEndpoint() {
    if (getIsDebugMode()) {
      ...
      return Uri.parse('http://api.joyful-noise.link/api/v1/auth');
    }
  }
  ...
  static Uri redirectUrl() {
    if (getIsDebugMode()) {
      ...
      return Uri.parse('http://api.joyful-noise.link/callback');
    }
  }
